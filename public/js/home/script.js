...
_defineProperty(BurgerMenu, "welcomeBlock", null);
var AddScrollUp = /*#__PURE__*/function () {
  function AddScrollUp() {
    _classCallCheck(this, AddScrollUp);
  }
  _createClass(AddScrollUp, null, [{
    key: "init",
    value: function init() {
      var _this2 = this;
      ...
      window.addEventListener('scroll', function () {
        ...
        if (posTop > _this2.screenHeight / 2 && !document.querySelector('.arrow-top')) {
          _this2.createArrowTop();
          document.querySelector('.main').append(_this2.arrowTop);
        }
        if (posTop <= _this2.screenHeight / 2 && document.querySelector('.arrow-top')) {
...
_defineProperty(AddScrollUp, "screenHeight", null);
_defineProperty(AddScrollUp, "arrowTop", null);
var Accordeon = /*#__PURE__*/function () {
  function Accordeon() {
    _classCallCheck(this, Accordeon);
  }
  _createClass(Accordeon, null, [{
    key: "init",
    value: function init() {
      var _this3 = this;
      ...
      this.heads.forEach(function (item) {
        item.addEventListener('click', function (e) {
          _this3.heads.forEach(function (item) {
...
_defineProperty(Accordeon, "heads", null);
_defineProperty(Accordeon, "bodies", null);
BurgerMenu.init();
AddScrollUp.init();
Accordeon.init();
})();
